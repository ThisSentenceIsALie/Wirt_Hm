'''
    File name: d4_gen.py
    Dependencies: D4_gens_pruned.txt
...
'''
Generates an exhaustive list of all minimal generating sets of reflections of the D4 Coxeter group
'''
...
class DGen:
    ...
    #Function to retrieve the list of 624 minimal generating sets from file produced in Sage
    def retriever(self):
        #Get directory of this file; also the directory of the pruned generator list
        dir_path = os.path.dirname(os.path.realpath(__file__))
        #Open said file
        generator_file=open(dir_path+'\\D4_gens_pruned.txt', 'r')
    ...
    def formater(self, content):
        ...
        for char in content:
            ...
            if char.isdigit():
                ...
                n+=1
                #If four elements have been added to the row...
                if n==4:
                    ...
                    #Reset row list
                    del single_row[:]
                #If four rows have been added to the matrix...
                if m==4:
                    ...
                    #Reset matrix
                    del single_matrix[:]
                #If four matrices have been added to the set...
                if i==4:
                    ...
                    del single_set[:]
            char_prev=char
        #Return a list of 624 lists of four numpy arrays
